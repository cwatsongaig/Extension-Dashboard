...
function renderExposureMap() {
    ...
    // Territory color palette — one distinct color per GAI branch territory
    const territoryColors = {
        ...
        'WALNUT CREEK': '#1565c0',
        'TENNESSEE': '#00838f',
        'CHICAGO CONTRACT': '#6d4c41',
        'CAROLINA': '#d97706',
        'TWIN CITIES': '#7b1fa2',
        'FLORIDA': '#2e7d32',
        'ATLANTA': '#c0392b',
        'PACIFIC NORTHWEST': '#ad1457',
        'ROCKY MOUNTAIN': '#e65100',
        'NEW ENGLAND': '#0d47a1',
        'MID-ATLANTIC': '#4a148c',
        'BIG SKY': '#bf360c',
        'TULSA': '#33691e',
...
function openExposureKPIDrillDown(type) {
    // Re-derive exposureRegions — must match the data in renderExposureMap
    const exposureRegions = [
        { name: 'KENTUCKY', abbr: 'KY', value: 6.2, bonds: 95, lossRatio: 1.9, largestBond: 1200000, trend: 'up', trendPct: 3.4, type: { contract: 4.8, commercial: 1.4 } },
        { name: 'CINCINNATI', abbr: 'CIN', value: 14.5, bonds: 210, lossRatio: 2.2, largestBond: 3200000, trend: 'up', trendPct: 5.1, type: { contract: 10.8, commercial: 3.7 } },
        { name: 'ORANGE', abbr: 'OR', value: 18.3, bonds: 280, lossRatio: 2.8, largestBond: 4100000, trend: 'up', trendPct: 6.8, type: { contract: 13.5, commercial: 4.8 } },
